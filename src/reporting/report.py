...
def build_excel_report(metrics_merged, ds_type, path:Path=None, checkpoints=None):
...
def build_pdf_report(metrics_merged, ds_type, metrics_merged_ranked, path:Path=None):
...
def build_png_dashboard(metrics_merged, ds_type, metrics_merged_ranked, path:Path=None, dpi=200):
